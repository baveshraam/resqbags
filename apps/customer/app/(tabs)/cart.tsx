      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>Bag price</Text>
            <Text style={styles.summaryValue}>₹{totalAmount}</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>Taxes/charges</Text>
            <Text style={styles.summaryValue}>Calculated at final payment</Text>
          </View>
          <View style={styles.summaryDivider} />
          <View style={styles.summaryRow}>
            <Text style={styles.totalLabel}>Total (demo)</Text>
